 ...
 * loaders, the Overview/Phase-review views, the F1 postMessage bridge, the
 * verdict panel) lives under components/ and lib/; this file's only job is
 * mounting.
 *
 ...
 * already global by the time ReviewEmbed reads them — same boot order the
